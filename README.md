...
the scripts and run them, but the instructions say don't run the scripts when
grading

The files are default created 480 x 480. The example unnamed png files from 
